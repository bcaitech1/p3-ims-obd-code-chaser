...
class UNet_3Plus_DeepSup_CGM(nn.Module):
    ...
    def forward(self, inputs):
        ...
        #cls_branch_softmax = F.log_softmax(cls_branch)
        ...
        hd1 = self.relu1d_1(self.bn1d_1(self.conv1d_1(
            self.up_1(torch.cat((h1_Cat_hd1, hd2_UT_hd1, hd3_UT_hd1, hd4_UT_hd1, hd5_UT_hd1), 1))))) # hd1->320*320*UpChannels
...
class UNet_3Plus(nn.Module):
    ...
    def __init__(self, in_channels=3, n_classes=1, feature_scale=4, is_deconv=True, is_batchnorm=True):
        ...
        filters = self.encoder.out_channels[1:] #[32, 24, 40, 112, 320]
